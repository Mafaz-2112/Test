...
int is_alpha(int);
int ato(char *);
char *getenvo(inf_t *, const char *);
int my_envo(inf_t *);
int my_setenvo(inf_t *);
int my_un_setenvo(inf_t *);
int pop_envo_lis(inf_t *);
int errato(char *);
...
void rm_comme(char *);
char **get_envo(inf_t *);
int un_setenvo(inf_t *, char *);
int set_env(inf_t *, char *, char *);
int my_his(inf_t *);
int my_ali(inf_t *);
...
int is_chn(inf_t *, char *, size_t *);
void ch_cha(inf_t *, char *, size_t *, size_t, size_t);
int rep_ali(inf_t *);
int rep_var(inf_t *);
